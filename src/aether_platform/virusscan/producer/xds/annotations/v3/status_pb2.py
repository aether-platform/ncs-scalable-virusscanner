...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 6, 31, 1, "", "xds/annotations/v3/status.proto"
)
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "xds.annotations.v3.status_pb2", _globals
)
if not _descriptor._USE_C_DESCRIPTORS:
    _globals["DESCRIPTOR"]._loaded_options = None
    _globals[
        "DESCRIPTOR"
    ]._serialized_options = b"Z)github.com/cncf/xds/go/xds/annotations/v3"
