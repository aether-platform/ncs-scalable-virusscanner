...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 6, 31, 1, "", "envoy/config/core/v3/backoff.proto"
)
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "envoy.config.core.v3.backoff_pb2", _globals
)
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_BACKOFFSTRATEGY"].fields_by_name[
        "base_interval"
    ]._serialized_options = b"\372B\013\252\001\010\010\0012\004\020\300\204="
    _globals["_BACKOFFSTRATEGY"].fields_by_name["max_interval"]._loaded_options = None
    _globals["_BACKOFFSTRATEGY"].fields_by_name[
        "max_interval"
    ]._serialized_options = b"\372B\005\252\001\002*\000"
    _globals["_BACKOFFSTRATEGY"]._loaded_options = None
    _globals[
        "_BACKOFFSTRATEGY"
