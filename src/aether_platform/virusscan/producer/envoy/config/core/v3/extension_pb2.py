...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 6, 31, 1, "", "envoy/config/core/v3/extension.proto"
)
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "envoy.config.core.v3.extension_pb2", _globals
)
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_TYPEDEXTENSIONCONFIG"].fields_by_name[
        "name"
    ...
    _globals["_TYPEDEXTENSIONCONFIG"].fields_by_name[
        "typed_config"
    ]._serialized_options = b"\372B\005\242\001\002\010\001"
